...
def Create_account():
    ...
    def button_1():
        ...
        if len(Accn)!=11 or Accn.isdigit()==False:
            ...
            with open("C:\\Users\\abise\\OneDrive\\Documents\\GUI PYTHON\\ATM.txt","r") as f:
                data=f.readlines()
                for i in data:
                                    ...
                                    if d>31:
                                        ...
                                        if m>12:
                                            ...
                                            if y<1950 or y>Y.year:
                                                ...
                                                with open("C:\\Users\\abise\\OneDrive\\Documents\\GUI PYTHON\\ATM.txt","a") as file:
    ...
    def Next():
        ...
        if len(accn.get())==0 or len(n.get())==0 or len(sn.get())==0 or len(g.get())==0 or len(dob.get())==0:
            ...
            with open("C:\\Users\\abise\\OneDrive\\Documents\\GUI PYTHON\\ATM.txt","r") as file:
                data=file.readlines()
                for i in data:
                    if i.startswith("Account Number: "+Accn):
                        ...
                        def previous1():
                            ...
                            with open("C:\\Users\\abise\\OneDrive\\Documents\\GUI PYTHON\\ATM.txt","r") as f:
                                    data=f.readlines()[:-1]
                                    f.seek(0)
                            with open("C:\\Users\\abise\\OneDrive\\Documents\\GUI PYTHON\\ATM.txt","w") as file:
                            ...
                            with open("C:\\Users\\abise\\OneDrive\\Documents\\GUI PYTHON\\ATM.txt","r") as file:
                                ...
                                #The or operator is used to combine these two conditions. If either of them is True, the entire expression evaluates to True. Otherwise, if both are False, the entire expression evaluates to False.    
                                        ...
                                        def deposit():
                                            ...
                                            def sub():
                                                Ac2=acn.get().strip()
                                                with open("C:\\Users\\abise\\OneDrive\\Documents\\GUI PYTHON\\History.txt","r") as f:
                                                    data=f.readlines()
                                                    if len(data)>0:
                                                        if Ac2:
                                                                ...
                                                                if Ac==get_binary(acn.get()):
                                                                    with open("C:\\Users\\abise\\OneDrive\\Documents\\GUI PYTHON\\ATM.txt","r+") as f:
                                                                        ...
                                                                        if val==True:
                                                                            ...
                                                                            def sub1():
                                                                                ...
                                                                                if Ac1:
                                                                                    if Ac1.isdigit() and int(Ac1)>0:
                                                                                        if int(Ac1)<=50000:
                                                                                            with open("C:\\Users\\abise\\OneDrive\\Documents\\GUI PYTHON\\Balance.txt","a") as file:
                                                                                            ...
                                                                                            with open("C:\\Users\\abise\\OneDrive\\Documents\\GUI PYTHON\\Balance.txt","r") as file:
                                                                                                    data=file.readlines()
                                                                                                    l=[]
                                                                                            ...
                                                                                            def ext3():
                                                                                                with open("C:\\Users\\abise\\OneDrive\\Documents\\GUI PYTHON\\Balance.txt","r") as file:
                                                                                                    ...
                                                                                                    if val3==True:
                                                                                                        with open("C:\\Users\\abise\\OneDrive\\Documents\\GUI PYTHON\\Balance.txt","w") as file:
                                                                                                            pass
                                                                                                        root5.destroy()
                                                                                                        new_root2.deiconify()
                                                                                            def proceed():
                                                                                                ...
                                                                                                with open("C:\\Users\\abise\\OneDrive\\Documents\\GUI PYTHON\\History.txt","a") as f:
                                                                                                ...
                                                                                                with open("C:\\Users\\abise\\OneDrive\\Documents\\GUI PYTHON\\History.txt","r") as f:
                                                                                                    ...
                                                                                                    if a>50000:
                                                                                                        ...
                                                                                                        with open("C:\\Users\\abise\\OneDrive\\Documents\\GUI PYTHON\\History.txt","r+") as f:
                                                                                                            ...
                                                                                                            f.truncate()
                                                                                                            f.writelines(history[:-1])
                                                                                                        with open("C:\\Users\\abise\\OneDrive\\Documents\\GUI PYTHON\\Balance.txt","w") as f:
                                                                                                            pass    
                                                                                                        if val3==True:
                                                                                                            with open("C:\\Users\\abise\\OneDrive\\Documents\\GUI PYTHON\\History.txt","r") as f:
                                                                                                                data=f.readlines()
                                                                            ...
                                                                            def ext2():
                                                                                with open("C:\\Users\\abise\\OneDrive\\Documents\\GUI PYTHON\\Balance.txt","r") as f:
                                                                                    data=f.readlines()
                                                                                    if len(data)==0:
                                                                                        root4.destroy()
                                                                                        new_root2.deiconify()
                                                                                                            ...
                                                                                                            for index,j in enumerate(data1):
                                                                                                                if j.startswith("ABALANCE|"):
                                                                                                                    ...
                                                                                                                    if int(w_amount.get())>d:
                                                                                                                        ...
                                                                                                                        with open("C:\\Users\\abise\\OneDrive\\Documents\\GUI PYTHON\\History.txt","w") as f:
                                                                                                                                f.writelines(data1) 
                                                                                                file.write(i)
                                                                                            file.truncate()       
                                                                            else:
                                        ...
                                        label.pack(fill=X)
                                        update_clock()
                                        new_root2.after(180000,hide_message_box)
                                        new_root2.mainloop()
                                else:
